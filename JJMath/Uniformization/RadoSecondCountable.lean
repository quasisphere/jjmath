...
/--
%%handwave
name: The ambient function represented by a local holomorphic real-part branch
statement:
  If a local branch is represented in a chart $z$ by a holomorphic
  potential $F$, define its ambient surface function by $x\mapsto F(z(x))$.
-/
